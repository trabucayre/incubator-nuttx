...
static inline void eoss3_disableuartint(struct eoss3_uart_s *priv, uint32_t *ie)
{
  if (ie)
    {
...
static inline void eoss3_restoreuartint(struct eoss3_uart_s *priv, uint32_t ie)
{
